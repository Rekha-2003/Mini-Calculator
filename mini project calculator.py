...
Button(root,text="/",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d46",command=lambda: show("/")).place(x=150,y=100)
...
Button(root,text="8",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d46",command=lambda: show("8")).place(x=150,y=200)
...
Button(root,text="5",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d46",command=lambda: show("5")).place(x=150,y=300)
...
Button(root,text="2",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d46",command=lambda: show("2")).place(x=150,y=400)
